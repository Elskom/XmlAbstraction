namespace XmlAbstraction.Test
{
    ...
    public class XmlObjectUnitTest
    {
        ...
        public void Test_create_file_remote_not_found_Fail()
        {
            ...
            Assert.Throws<DirectoryNotFoundException>(() => new XmlObject($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}testCreate.xml", testXml, true));
            File.Delete($"{Environment.CurrentDirectory}{Path.DirectorySeparatorChar}testCreate.xml");
        }
